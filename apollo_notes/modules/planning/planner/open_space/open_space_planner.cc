...
apollo::common::Status OpenSpacePlanner::Plan(
  ...
  ego << front_to_center_, back_to_center_, left_to_center_, right_to_center_;///< 向矩阵写入车辆信息
  ...
  Eigen::MatrixXd XYbounds(4, 1);///< 车库形状
  XYbounds << -15, 15, 1, 10;
