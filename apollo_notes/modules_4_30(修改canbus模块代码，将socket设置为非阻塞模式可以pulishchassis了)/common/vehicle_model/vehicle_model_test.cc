...
class VehicleModelTest : public ::testing::Test {
 public:
  virtual void SetUp() {
    ...
    ACHECK(apollo::common::util::GetProtoFromFile(localization_pre_file,
                                           &localization_pre_));
    std::string localization_post_file =
        "modules/common/testdata/localization_post.pb.txt";
    ACHECK(apollo::common::util::GetProtoFromFile(localization_post_file,
                                           &localization_post_));
    const std::string chassis_pre_file =
        "modules/common/testdata/chassis_pre.pb.txt";
    ACHECK(apollo::common::util::GetProtoFromFile(chassis_pre_file, &chassis_pre_));
    const std::string chassis_post_file =
        "modules/common/testdata/chassis_post.pb.txt";
    ACHECK(apollo::common::util::GetProtoFromFile(chassis_post_file, &chassis_post_));
  }
