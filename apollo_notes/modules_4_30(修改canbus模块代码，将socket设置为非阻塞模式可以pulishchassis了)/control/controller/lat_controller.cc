...
void LatController::ProcessLogs(const SimpleLateralDebug *debug,
  ...
  const std::string log_str = common::util::StrCat(
      common::util::StrCat(debug->lateral_error(), ",", debug->ref_heading(), ",",
             VehicleStateProvider::instance()->heading(), ",",
             debug->heading_error(), ","),
      common::util::StrCat(debug->heading_error_rate(), ",", debug->lateral_error_rate(), ",",
             debug->curvature(), ",", debug->steer_angle(), ","),
      common::util::StrCat(debug->steer_angle_feedforward(), ",",
             debug->steer_angle_lateral_contribution(), ",",
             debug->steer_angle_lateral_rate_contribution(), ",",
             debug->steer_angle_heading_contribution(), ","),
      common::util::StrCat(debug->steer_angle_heading_rate_contribution(), ",",
